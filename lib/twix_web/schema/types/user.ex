defmodule TwixWeb.Schema.Types.User do
  ...
  object :user do
    ...
    field :age, non_null(:integer), description: "Greater or equal to 18"
    field :email, non_null(:string)

    field :posts, list_of(:post), description: "Return posts paginated" do
      arg :page, :integer, default_value: 1
      arg :per_page, :integer, default_value: 10

      resolve &UseResolver.get_user_posts/3
    end
